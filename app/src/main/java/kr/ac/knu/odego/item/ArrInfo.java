...
public class ArrInfo {
    ...
    private int remainBusStopCount; // 현재버스의 남은 정류소
    private String message; // 도착정보없을 때 메시지(이 값이 null이 아니면 위의 값들 다 없음)

    public ArrInfo(int remainMin, String curBusStopName, String endBusStopName, int remainBusStopCount) {
        this.remainMin = remainMin;
        this.curBusStopName = curBusStopName;
        this.endBusStopName = endBusStopName;
        this.remainBusStopCount = remainBusStopCount;
    }
}
